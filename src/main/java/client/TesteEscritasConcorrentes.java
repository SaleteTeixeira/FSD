...
public class TesteAula {
    public static void main(final String[] args) {
        ...
        ms.registerHandler("put", (BiConsumer<Address, byte[]>) (o, m) -> {
            final PutReply reply = s.decode(m);

            System.out.println("Recebido put: "+reply.toString());
        }, es);

        ms.registerHandler("get", (BiConsumer<Address, byte[]>) (o, m) -> {
        ...
        ms.sendAsync(Address.from(12345), "put", s.encode(new PutRequest(-1, 1, t1)));
        ...
        ms.sendAsync(Address.from(12345), "put", s.encode(new PutRequest(-1, 0, t2)));
        ...
        ms.sendAsync(Address.from(12345), "get", s.encode(new GetRequest(-1, 2, keys)));
    }
}